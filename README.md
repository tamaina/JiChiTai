...
出題方法は「都道府県当て」「市区町村当て」「タイピング」、ルールは「2分アタック」「練習」に対応しています。タイピングとは別に、自治体から市外局番を入力するクイズと、市外局番から自治体を選ぶ4択クイズも遊べます。都道府県・人口トップ1000・市のみのフィルタ、回答履歴、所在地プレビュー、結果共有、入力文字数とKPM/WPMの集計を備えています。
